...
Investigation rules:
- For .ts/.js, prefer `bun scripts/outline.ts <file>` for top-level structure — bundled in this skill, far more compact than LSP documentSymbol (needs bun + typescript ≥5; it prints a skip notice otherwise — then use LSP).
